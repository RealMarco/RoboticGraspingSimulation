...
def save_results(rgb_img, grasp_q_img, grasp_angle_img, depth_img=None, no_grasps=1, grasp_width_img=None,name=''):
    """
    Plot the output of a network
    :param rgb_img: RGB Image
    :param depth_img: Depth Image
    ...
    ax.set_title('RGB')
    ax.axis('off')
    fig.savefig('results/%s_%s_rgb.png' % (time,name))
    ...
    if depth_img.any():
        ...
        ax.set_title('Depth')
        ax.axis('off')
        fig.savefig('results/%s_%s_depth.png' % (time,name))
    ...
    ax.set_title('Grasp')
    ax.axis('off')
    fig.savefig('results/%s_%s_grasp.png' % (time,name))
    ...
    ax.axis('off')
    plt.colorbar(plot)
    fig.savefig('results/%s_%s_quality.png' % (time,name))
    ...
    ax.axis('on')
    plt.colorbar(plot)
    fig.savefig('results/%s_%s_angle.png' % (time,name))
    ...
    ax.axis('off')
    plt.colorbar(plot)
    fig.savefig('results/%s_%s_width.png' % (time,name))
